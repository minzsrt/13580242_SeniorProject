...
<div class="tab-content">
  <div class="tab-pane active container" id="menu1">
    ...
    <div class="tab-pane container" id="menu2">
        ...
        <div class="card" style="border:0; margin:10px auto; ">
                <button onclick="window.location.href='/listPackage'" class="btn" style="height:60px; padding: 0; border-radius: 10px; border: 1px dashed #a3a3a3; box-shadow: 0px 5px 8px rgba(0,0,0,0.1);">
                    <i class="fas fa-plus-circle"></i>
                </button> 
        </div>  
        <div class="container wrap_container_head">
