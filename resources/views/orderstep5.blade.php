...
<body>
    ...
    <div class="container">
        ...
        <form action="/{{$username}}/order/step5" method="POST" class="mt-4">
            ...
            <div class="row">
                <div class="col">
                    <button class="btn_color" onclick="window.location.href='/orderstep4'" style="background:#fff; border:1px solid #72AFD3; color:#72AFD3; width:100%; margin:0;">กลับ</button>
                </div>
                <div class="col">
